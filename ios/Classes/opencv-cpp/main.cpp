...
void disposeYolo8();
extern "C" __attribute__((visibility("default"))) __attribute__((used))
void image_ffi_yuv24(unsigned char *yData, unsigned char *uData, unsigned char *vData, int width, int height, int uvRowStride, int uvPixelStride, int *segBoundary, int *segBoundarySize, unsigned char **jpegBuf, int *jpegSize);
extern "C" __attribute__((visibility("default"))) __attribute__((used))
const char*  classifyPathImage(unsigned char* buf, int size);
extern "C" __attribute__((visibility("default"))) __attribute__((used))
void initClassifier(char *modelPath, char *paramPath);
extern "C" __attribute__((visibility("default"))) __attribute__((used))
...
extern "C" __attribute__((visibility("default"))) __attribute__((used))
const char* blurImage(unsigned char* buf, int size, double threshold,unsigned char* yData, unsigned char* uData, unsigned char* vData, int width, int height, int uvRowStride, int uvPixelStride,unsigned char** outputImageBuffer, int* outputImageSize);
extern "C" __attribute__((visibility("default"))) __attribute__((used))
const char* blurPathImage(unsigned char* buf, int size, double threshold);
extern "C" __attribute__((visibility("default"))) __attribute__((used))
const char* blurImageYUV240(unsigned char* buf, int size, double threshold,unsigned char* yData, unsigned char* uData, unsigned char* vData, int width, int height, int uvRowStride, int uvPixelStride);
extern "C" __attribute__((visibility("default"))) __attribute__((used))
